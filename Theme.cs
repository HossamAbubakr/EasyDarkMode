    internal static class Theme
    {
        ...
        private static void ThemeControl(Control control)
        {
            ...
            {
                if (controlType == typeof(Button) || controlType == typeof(CheckedListBox) || controlType == typeof(RichTextBox) || controlType == typeof(TextBox) || controlType == typeof(ComboBox) || controlType == typeof(ListView) || controlType == typeof(ListBox))
                {
        ...
        public static Bitmap imageGreyscale(Bitmap input)
        {
